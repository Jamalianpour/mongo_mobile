...
class JsonViewerWidget extends StatefulWidget {
  ...
  const JsonViewerWidget(this.jsonObj, this.expandAll, {this.notRoot});
      ...
      list.add(
        InkWell(
          onTap: ink
              ...
              : null,
          onLongPress: () {
            print(getValueWidget(entry.value));
          },
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
...
class JsonArrayViewerWidget extends StatefulWidget {
  ...
  const JsonArrayViewerWidget(this.jsonArray, this.expandAll, {this.notRoot});
...
Widget getValueWidget(dynamic content) {
  ...
  } else if (content is Mongo.ObjectId) {
